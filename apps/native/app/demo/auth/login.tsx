...
export default function LoginScene() {
  ...
  return (
    <>
      <Stack.Screen
        options={{ title: "Sign in to your account", headerShown: true, headerBackButtonDisplayMode: "minimal" }}
      />
          ...
          <Auth className="flex-1 px-6 pt-4">
            ...
            <Auth.Actions className="flex-1">
              <Button className="w-full bg-foreground" onPress={form.handleSubmit(onSubmit)} variant="ghost">
                ...
                <Button.Label className="text-background">Login with Google</Button.Label>
              </Button>
              <Button className="w-full bg-foreground" onPress={form.handleSubmit(onSubmit)} variant="ghost">
                <AppleIcon className="size-6" />
                <Button.Label className="text-background">Login with Apple</Button.Label>
              </Button>
            </Auth.Actions>
            <Auth.Actions>
              <Link asChild href="/demo/auth/register" replace>
                <Button variant="ghost">
                  <Button.Label className="text-muted text-sm">Create a new account</Button.Label>
                </Button>
              </Link>
